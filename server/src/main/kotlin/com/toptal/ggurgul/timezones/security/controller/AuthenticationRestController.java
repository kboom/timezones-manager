...
public class AuthenticationRestController {
    ...
    public ResponseEntity<?> createAuthenticationToken(
        ...
        final Authentication authentication = authenticate(authenticationRequest);
    ...
    private Authentication authenticate(JwtAuthenticationRequest authenticationRequest) {
